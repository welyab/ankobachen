...
class FenString(val fen: String, val chessVarian: ChessVarian = ChessVarian.STANDARD) {
    ...
    fun getFenInfo(): FenInfo {
        ...
        fenInfo = FenInfo(
            ...
            castlingFlags = parseCastlingFlags(fenParts.getOrNull(2), fenParts.getOrNull(0)),
    ...
    private fun parseCastlingFlags(castlingFlagsPart: String?, pieceDispositionPart: String?): CastlingFlags {
        if (castlingFlagsPart == null || castlingFlagsPart == "-") return CastlingFlags()

        val blackFirstLine = pieceDispositionPart!!.substring(0, pieceDispositionPart!!.indexOf('/'))
        val whiteFirstLine = pieceDispositionPart!!.substring(pieceDispositionPart!!.lastIndexOf('/') + 1)
        ...
        if (
            ...
            val columnIndex = whiteFirstLine.lastIndexOf(WHITE_ROOK_LETTER)
            index++
        ...
        if (
            ...
            val columnIndex = whiteFirstLine.indexOf(WHITE_ROOK_LETTER)
            index++
        ...
        if (
            ...
            val columnIndex = blackFirstLine.lastIndexOf(BLACK_ROOK_LETTER)
            index++
        ...
        if (
            ...
            val columnIndex = blackFirstLine.indexOf(BLACK_ROOK_LETTER)
            index++
