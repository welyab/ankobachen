...
enum class Position(
    ...
    val squareIndex get() = rowColumnToSquareIndex(row, column)
    ...
    companion object {
        ...
        fun squareIndexToRow(squareIndex: Int): Int = squareIndex / 8

        fun squareIndexToColumn(squareIndex: Int): Int = squareIndex % 8

        fun from(squareIndex: Int): Position = from(
            squareIndexToRow(squareIndex),
            squareIndexToColumn(squareIndex)
        )

        fun rowColumnToSquareIndex(row: Int, column: Int): Int = row * 8 + column
    }
}
